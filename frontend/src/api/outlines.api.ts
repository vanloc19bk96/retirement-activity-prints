import type { ListOutlineAssetsResponse } from '@/types/outlines.types'
...
export const outlinesApi = {
  getAssets: async (params: {
    ...
    offset?: number
    signal?: AbortSignal
  }): Promise<ListOutlineAssetsResponse> => {
    ...
    const response = await fetch(`/api/outlines/assets?${query}`, {
      method: 'GET',
      headers: authHeader,
    ...
    return (await response.json()) as ListOutlineAssetsResponse
  },
}
